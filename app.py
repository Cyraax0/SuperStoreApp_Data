...
import pandas as pd
import altair as alt #new1
import plotly.express as px #new2
...
try:
    ...
    #generate multi-select filter widget dynamically
    ...
    #apply use selections to the data 
    ...
    with col3:
        #st.write(f"Number of Orders: {no_orders:,.2f}")
